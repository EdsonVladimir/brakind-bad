...
const login = async (req, res)=>{
    ...
    const query = `select id_usuario, nombre,email, nickname, contrasenia from core.usuario where email=$1`
    try {
        ...
        const {id_usuario, email, nombre, contrasenia, nickname} = resultado.rows[0];
